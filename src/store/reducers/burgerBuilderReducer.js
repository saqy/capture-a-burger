...
const addIngredient = (state,action) => {
    const updatedIngredByAdd = {[action.ingredientName]: state.ingredients[action.ingredientName] + 1}
    const updatedIngredientsByAdd = updateObject(state.ingredients, updatedIngredByAdd)
...
const removeIngredient = (state,action)=> {
    const updatedIngredByRemove = {[action.ingredientName]: state.ingredients[action.ingredientName] - 1}
    const updatedIngredientsByRemove = updateObject(state.ingredients, updatedIngredByRemove)
